...
import { FileText, Download, Search, Filter, BookOpen, FolderOpen, ArrowLeft, Calendar, User, Layers, Trash2 } from 'lucide-react'
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mt-1">Select a class to view and manage notes</p>
                        </div>
                        {classes.length > 0 && (
                                ...
                                <div className="group block h-full">
                                    <div className="relative overflow-hidden bg-indigo-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <p className="text-sm opacity-90 mb-3">Manage notes</p>
            ...
            <div className="space-y-6">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    <div className="flex items-center gap-4 mb-6">
                        <button onClick={() => setClassId(null)} className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            <ArrowLeft className="w-5 h-5" />
                        </button>
                        <div>
                            <h1 className="text-3xl font-bold">Subjects – {currentClass?.title}</h1>
                            <p className="text-gray-600 dark:text-gray-400 mt-1">Select a subject to manage notes</p>
                        </div>
                    </div>
                </motion.div>
                                ...
                                <div className="group block h-full">
                                    <div className="relative overflow-hidden bg-purple-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <p className="text-sm opacity-90 mb-3">View notes</p>
                                            <div className="flex items-center text-xs opacity-80">
                                                <span>Click to select</span>
                                                <ArrowLeft className="w-3 h-3 ml-1 rotate-180" />
                                            </div>
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mt-1">{currentClass?.title} - Manage Notes</p>
                    </div>
                </div>
