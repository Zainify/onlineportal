...
import { BookOpen, Plus, Search, Trash2, AlertCircle, CheckCircle } from 'lucide-react'
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Create and manage academic subjects</p>
          </div>
        </div>
      </motion.div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">({filteredSubjects.length} total)</span>
              </div>
